...
var pgTypes = __webpack_require__(247)
...
/* 
  This file is part of @pglint/action.
...
const pg = __webpack_require__(792);
...
async function main() {
  const token = process.env.PGLINT_TOKEN;
  if (!token) {
    const pont = core.getInput("pass-on-no-token");
    if (pont) {
      console.error(
        `Environmental variable PGLINT_TOKEN was not set and pass-on-no-token is truthy ('${inspect(
          pont
        )}'); skipping checks.`
      );
      return;
    ...
    throw new Error(
      "Environmental variable PGLINT_TOKEN was not set, so PGLint checks cannot be performed."
    );
  }
  const project = core.getInput("project") || process.env.PGLINT_PROJECT;
  if (!project) {
    throw new Error(
  ...
  try {
    ...
    const response = await fetch(
      `https://pglint.com/api/upload?project=${encodeURIComponent(project)}` +
    ...
    if (data) {
      ...
      switch (data.status) {
        ...
        case "TIMEOUT": {
          ...
          core.setFailed("A timeout occurred waiting for results from PGLint.");
          return;
        }
        case "ERROR": {
          core.setFailed(
            "An error occurred when trying to run PGLint checks against your database."
          );
          return;
        }
        case "FAIL": {
          core.setFailed("Your database schema has some PGLint errors.");
          return;
        }
        default: {
...
const buffer_reader_1 = __webpack_require__(343);
...
var Native = __webpack_require__(973)
var TypeOverrides = __webpack_require__(309)
var semver = __webpack_require__(280)
var pkg = __webpack_require__(964)
var assert = __webpack_require__(357)
var EventEmitter = __webpack_require__(614).EventEmitter
var util = __webpack_require__(669)
var ConnectionParameters = __webpack_require__(589)

var msg = 'Version >= ' + pkg.minNativeVersion + ' of pg-native required.'
assert(semver.gte(Native.version, pkg.minNativeVersion), msg)

var NativeQuery = __webpack_require__(777)
...
var textParsers = __webpack_require__(739);
var binaryParsers = __webpack_require__(820);
var arrayParser = __webpack_require__(440);
var builtinTypes = __webpack_require__(602);
...
var types = __webpack_require__(247)
...
var sasl = __webpack_require__(781)
var pgPass = __webpack_require__(531)
var TypeOverrides = __webpack_require__(309)

var ConnectionParameters = __webpack_require__(589)
var Query = __webpack_require__(476)
var defaults = __webpack_require__(31)
var Connection = __webpack_require__(496)
...
var array = __webpack_require__(994);
...
const Result = __webpack_require__(976)
const utils = __webpack_require__(848)
...
const { parse, serialize } = __webpack_require__(796)
...
class Pool extends EventEmitter {
  constructor(options, Client) {
    ...
    this.Client = this.options.Client || Client || __webpack_require__(792).Client
...
var parse = __webpack_require__(881).parse // parses a connection string
...
Object.defineProperty(exports, "__esModule", { value: true });
const buffer_writer_1 = __webpack_require__(558);
...
var array = __webpack_require__(994)
var arrayParser = __webpack_require__(440);
var parseDate = __webpack_require__(867);
var parseInterval = __webpack_require__(214);
var parseByteA = __webpack_require__(341);
...
var Client = __webpack_require__(351)
var defaults = __webpack_require__(31)
var Connection = __webpack_require__(496)
var Pool = __webpack_require__(539)
...
var PG = function (clientConstructor) {
  ...
  this.types = __webpack_require__(247)
}

if (typeof process.env.NODE_PG_FORCE_NATIVE !== 'undefined') {
  module.exports = new PG(__webpack_require__(315))
} else {
  ...
  Object.defineProperty(module.exports, 'native', {
    ...
    get() {
      var native = null
      try {
        native = new PG(__webpack_require__(315))
      } catch (err) {
...
Object.defineProperty(exports, "__esModule", { value: true });
const serializer_1 = __webpack_require__(736);
exports.serialize = serializer_1.serialize;
const parser_1 = __webpack_require__(153);
...
var parseInt64 = __webpack_require__(746);
...
module.exports = {"name":"pg","version":"8.2.1","description":"PostgreSQL client - pure javascript & libpq with the same API","keywords":["database","libpq","pg","postgre","postgres","postgresql","rdbms"],"homepage":"https://github.com/brianc/node-postgres","repository":{"type":"git","url":"git://github.com/brianc/node-postgres.git"},"author":"Brian Carlson <brian.m.carlson@gmail.com>","main":"./lib","dependencies":{"buffer-writer":"2.0.0","packet-reader":"1.0.0","pg-connection-string":"^2.2.3","pg-pool":"^3.2.1","pg-protocol":"^1.2.4","pg-types":"^2.1.0","pgpass":"1.x","semver":"4.3.2"},"devDependencies":{"async":"0.9.0","bluebird":"3.5.2","co":"4.6.0","pg-copy-streams":"0.3.0"},"minNativeVersion":"2.0.0","scripts":{"test":"make test-all"},"files":["lib","SPONSORS.md"],"license":"MIT","engines":{"node":">= 8.0.0"},"gitHead":"f3136a7d5d5498280924b3e06f47f8ce80dbe4e6"};
